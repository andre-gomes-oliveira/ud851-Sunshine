...
public class MainActivity extends AppCompatActivity {
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected String[] doInBackground(String... params) {
            ...
            URL fetchUrl = NetworkUtils.buildUrl(params[0]);
            try {
                String fetchResults = NetworkUtils.getResponseFromHttpUrl(fetchUrl);
                String [] fetchedData = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this, fetchResults);
                return fetchedData;
            }
            catch (IOException e)
            {
        ...
        protected void onPostExecute(String[] fetchedData) {
            if(fetchedData != null) {
                for (String weatherString : fetchedData) {
