...
public class MainActivity extends AppCompatActivity implements
    ...
    // COMPLETED (4) Add a private static boolean preferencesUpdated for preference updates and initialize it to false
    ...
    // COMPLETED (5) Override onSharedPreferenceChanged to set the preferences preferencesUpdated to true
    @Override
