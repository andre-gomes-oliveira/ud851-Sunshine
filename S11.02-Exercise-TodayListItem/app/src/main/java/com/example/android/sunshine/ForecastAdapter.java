...
//  COMPLETED (6) Declare constant IDs for the ViewType for today and for a future day
    private final int TODAY_VIEW_ID = 88;
    private final int FUTURE_VIEW_ID = 44;
...
//      COMPLETED (11) Otherwise, return the ID for future day viewType
    ...
    public int getItemViewType(int position) {
        if(mUseTodayLayout && position == 0)
            return getItemViewType(TODAY_VIEW_ID);
        else
            return getItemViewType(FUTURE_VIEW_ID);
    }
