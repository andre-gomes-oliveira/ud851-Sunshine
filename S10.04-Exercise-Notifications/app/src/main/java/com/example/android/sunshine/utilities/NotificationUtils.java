...
//  COMPLETED (1) Create a constant int value to identify the notification
    public static final int WEATHER_NOTIFICATION_ID = 1414;
...
//          COMPLETED (3) Create an Intent with the proper URI to start the DetailActivity
            Intent intentToStartDetails = new Intent(context, DetailActivity.class);
            intentToStartDetails.setData(todaysWeatherUri);

//          COMPLETED (4) Use TaskStackBuilder to create the proper PendingIntent
            TaskStackBuilder taskStackBuilder = TaskStackBuilder.create(context);
            taskStackBuilder.addNextIntentWithParentStack(intentToStartDetails);
