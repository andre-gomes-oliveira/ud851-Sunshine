...
public class ForecastAdapter extends RecyclerView.Adapter<ForecastAdapter.ForecastAdapterViewHolder> {
    ...
    public ForecastAdapter(ForecastAdapterOnClickHandler forecastAdapter) {
        mClickHandler = forecastAdapter;

    }

    // COMPELTED (5) Implement OnClickListener in the ForecastAdapterViewHolder class
    /**
