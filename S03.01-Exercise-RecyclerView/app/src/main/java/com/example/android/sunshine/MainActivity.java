...
public class MainActivity extends AppCompatActivity {
    ...
    // OCMPLETED (5) Add a layout for an item in the list called forecast_list_item.xml
    // OCMPLETED (6) Make the root of the layout a vertical LinearLayout
    // OCMPLETED (7) Set the width of the LinearLayout to match_parent and the height to wrap_content

    // OCMPLETED (8) Add a TextView with an id @+id/tv_weather_data
    // OCMPLETED (9) Set the text size to 22sp
    // OCMPLETED (10) Make the width and height wrap_content
    // OCMPLETED (11) Give the TextView 16dp of padding

    // OCMPLETED (12) Add a View to the layout with a width of match_parent and a height of 1dp
    // OCMPLETED (13) Set the background color to #dadada
